...
import com.thor.person.Person;
import com.thor.person.Person1;
...
public class StringUtil {
	private static String[] surName ={"赵","钱","孙","李","周","吴","郑","王","冯","陈","楮","卫","蒋","沈","韩","杨","朱","秦",
			...
			"查","后","荆","红","游","竺","权","逑","盖","益","桓","公","仉","督","晋","楚","阎","法","汝","鄢","涂",
			"钦","归","海","岳","帅","缑","亢","况","后","有","琴","商","牟","佘","佴","伯","赏","墨","哈","谯","笪",
			"年","爱","阳","佟","万俟","司马","上官","欧阳","夏侯","诸葛","闻人","东方","赫连","皇甫", "尉迟","公羊",
			"澹台","公冶","宗政", "濮阳","淳于","单于","太叔","申屠", "公孙","仲孙","轩辕","令狐","锺离","宇文",
			"长孙","慕容","鲜于","闾丘", "司徒","司空","丌官","司寇","南宫","子车","颛孙","端木","巫马","公西", 
			"漆雕","乐正","壤驷","公良","拓拔", "夹谷","宰父","谷梁","段干","百里","东郭","南门","呼延","羊舌",
			"微生", "梁丘","左丘","东门","西门"};
	
	public static void main(String[] args) {
		System.out.println("该字符串"+isEmpteIf(" "));
		System.out.println(getChinese(3));
	 ...
	 * @return
	 */
	public static boolean isEmpteIf(String str) {
	...
	/**
	 * 取名工具，返回中文姓名，必须以真实姓开头，试卷中附有百家姓，名使用 1-2 个随机汉字，内部调用③方法。
	 * @return
	 */
	public static String getName() {
		...
		String secondName = getChinese(random.nextInt(2)+1);
	...
	public static void createPerson() {
		...
		for (int i = 0; i < 10; i++) {
			...
			person.setDescription(getChinese(6));
			/*Math.random()*(20190101-19990101)
			person.setPdate();
